...
public class BeehiveController {
  ...
  public String getBeehives(@PathVariable("id") Long apiaryId,
    ...
    try {
      ...
      model.addAttribute("apiaries", apiaryService.getApiariesByUserId(user.getId()));
  ...
  public String saveApiary(@ModelAttribute BeehiveDto beehiveForm, BindingResult bindingResult,
  ...
  public String handleDeleteBeehive(@PathVariable("id") Long beehiveId, RedirectAttributes redirectAttributes) {
    ...
    try {
      ...
      redirectAttributes.addFlashAttribute("message",
          "The Beehive with id=" + beehiveId + " has been deleted successfully!");
    } catch (Exception e) {
  ...
  public String getBeehiveDetails(@PathVariable("id") Long beehiveId,
    ...
    try {
      ...
      Page<BeehiveWeightDto> beehivePage = new PageImpl<>(list, PageRequest.of(currentPage, pageSize),
          beehiveWeightDtos.size());
      new PageImpl<>(list, PageRequest.of(currentPage, pageSize), beehiveWeightDtos.size());
